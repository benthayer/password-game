        ...
        <div className="practice-modal-overlay" onClick={onClose}>
          <div className="practice-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="practice-modal-body">
              <p>
                You can enter practice mode by first going through recovery mode and using it to reconstruct your password. Once you do that, you can click the practice mode button at the top.
              </p>
            </div>
